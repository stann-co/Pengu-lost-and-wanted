...
export function sortStringsByLength(strings) {
    return strings.sort((string1, string2) => string1.length - string2.length);
}
export function getShortestString(strings) {
 ...
 *
 */
export function nodent(strings, ...interps) {
...
export function decodeFromBase64JsonString(string) {
    try {
...
export function encodeToBase64JsonString(something) {
    try {
 ...
 */
export function explode(string, options) {
    options ||= {};
 ...
 */
export function stringIsMatch(str, pattern) {
...
export function matchAll(string, pattern) {
