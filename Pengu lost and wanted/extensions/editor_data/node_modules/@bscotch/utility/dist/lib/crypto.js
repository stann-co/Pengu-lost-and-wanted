 ...
 */
export function hash(algorithm, source, encoding = 'hex') {
    return (nodeCrypto
...
export function sha1(source, encoding = 'hex') {
    return hash('sha1', source, encoding);
}
export function sha256(source, encoding = 'hex') {
    return hash('sha256', source, encoding);
}
export function md5(source, encoding = 'hex') {
 ...
 */
export function decrypt(encryptionString, key) {
    assert(key.length == 32, 'Key must be length 32');
...
export function randomBytes(bytes, encoding) {
...
export function randomString(length, characterSet) {
