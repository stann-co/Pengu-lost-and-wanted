...
if(ImGui.BeginViewportSideBar("left",0,ImGuiDir.Left,256)){
...
if(ImGui.BeginViewportSideBar("submenu",0,ImGuiDir.Up,32,ImGuiWindowFlags.NoBackground)){
    ImGui.ImageButton("btn1",spr_fuzzy_die,0,WHITE,1,WHITE,0)
    ImGui.SameLine()
    ImGui.ImageButton("btn2",spr_fuzzy_die,0,WHITE,1,WHITE,0)
    ImGui.End()
}
ImGui.PopStyleVar(1)
...
//#region dockspaces
//var _dockspace = ImGui.DockSpaceOverViewport(ImGuiDockNodeFlags.PassthruCentralNode | ImGuiDockNodeFlags.NoTabBar | ImGuiDockNodeFlags.NoUndocking | ImGuiDockNodeFlags.None);
//if (not initialized) {
    //var _dock_menu = ImGui.DockBuilderSplitNode(_dockspace, ImGuiDir.Up, 0.05);
    //var _dock_left = ImGui.DockBuilderSplitNode(_dock_menu[2], ImGuiDir.Left, 0.2);
    ////var _dock_right = ImGui.DockBuilderSplitNode(_dockspace, ImGuiDir.Right, 0.2);
	////var _dock_center = ImGui.DockBuilderSplitNode(_dock_right[1], ImGuiDir.Left, 0.2);
    //
    //ImGui.DockBuilderDockWindow("Menu", _dock_menu[1]);
    //
    //ImGui.DockBuilderDockWindow("Left", _dock_left[1]);
	//
    ////ImGui.DockBuilderDockWindow("Center", _dock_center[1]);
	//
	////ImGui.DockBuilderDockWindow("Hitboxes", _dock_center[2])
	//
    ////ImGui.DockBuilderDockWindow("Timeline", _dock_right[2]);
    //
    //ImGui.DockBuilderFinish(_dockspace);
    //initialized = true;
//}
//#endregion
//
//if(ImGui.Begin("Left",true)){
    //ImGui.End()
//}
