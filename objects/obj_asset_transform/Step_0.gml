...
if(obj_level_editor.element_active == id){
	...
	var x_ = global.camera.get_mouse_x() - (floor(global.camera.get_x() * parralax_x_) + offset_x_);
	var y_ = global.camera.get_mouse_y() - (floor(global.camera.get_y() * parralax_y_) + offset_y_);
