...
airborne_body_snap_rate = 1 / (SECOND*2);
	...
	static step = function(){
		...
		if(stepping){
			if(t <= mech.foot_step_time){
				...
				global.camera.shake_screen(4,SECOND*0.1);
            ...
            for (var i_ = 0; i_ < num; i_++) {
                ...
                if(!inst.invulnerable){
                    ...
                    global.camera.shake_screen(8,SECOND*1);
	...
	.add("airborne", {
		...
		step: function() {
			...
			if(on_land){
				...
				global.camera.shake_screen(10,SECOND*0.2);
