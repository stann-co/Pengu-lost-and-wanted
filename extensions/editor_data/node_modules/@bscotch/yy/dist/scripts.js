 ...
 */
export async function addScript(yypPath, scriptName, content) {
    let result = 'noop';
    assert(yypPath.endsWith('.yyp'), 'First argument must be a path to a .yyp file');
    assert(scriptName.match(/^[a-zA-Z_][a-zA-Z_0-9]*$/), 'Invalid script name. Must be a GameMaker-compatible name.');
