...
export type Decorator<T = any, V = any> = (target: T, propertyKey?: string, descriptor?: TypedPropertyDescriptor<V>) => any;
/**
 ...
 */
export interface DecoratedExecutionContext<Store = undefined, F extends Method = Method> extends Decorated {
    /**
 ...
 */
export interface DecoratedExecutedContext<Store = undefined, F extends Method = Method> extends DecoratedExecutionContext<Store, F> {
 ...
 */
export interface DecoratedResolvedContext<Store = undefined, F extends Method = Method> extends DecoratedExecutionContext<Store, F> {
 ...
 */
export interface DecoratorOptions<Store = undefined, M extends Method = Method> {
    /**
    ...
    methodHooks?: {
         ...
         */
        before?: (context: DecoratedExecutionContext<Store, M>) => void | Parameters<M>;
        /**
         ...
         * Only available for method decorators.
         */
        after?: (context: DecoratedExecutedContext<Store, M>) => void | ReturnType<Method>;
        /**
...
//# sourceMappingURL=decorator.types.d.ts.map